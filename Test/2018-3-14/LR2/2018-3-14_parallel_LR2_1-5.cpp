...
int main(int argc, char* argv[])
{
    ...
    MPI_Wtime_avg_comparator(stop - start, n, rank, ROOT_RANK, sendbuf, size, MPI_CHAR, recvbuf, n * size, MPI_CHAR, MPI_COMM_WORLD, MPI_Allgather);
