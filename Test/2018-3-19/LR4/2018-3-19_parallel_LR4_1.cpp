/*
Разработать OpenMP - программу, выполняющую поэлементное и постолбцовое
вычисление произведения квадратных матриц в разделяемой памяти.Сравнить
время выполнения двух версий программ в зависимости от размера матрицы
